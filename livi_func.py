...
#        self['livires']['areabins'] = sareas
        ...
        reslists.append([str(frame), 'Zone', self.id_data.name, 'Color X', ' '.join([str(ra[0]) + "\t" for ra in xyzirrad])])
        reslists.append([str(frame), 'Zone', self.id_data.name, 'Color Y', ' '.join([str(ra[1]) + "\t" for ra in xyzirrad])])
        reslists.append([str(frame), 'Zone', self.id_data.name, 'Color Z', ' '.join([str(ra[2]) + "\t" for ra in xyzirrad])])
        if svp['liparams']['unit'] == 'W/m2 (f)':
